...
class MenuTestDataService {
  ...
  List<Categoria> _creaCategorieDiTest() {
    return [
      Categoria(id: 'macro1', macrocategoriaId: 'macro1', nome: 'ANTIPASTI', ordine: 1, emoji: '🥗', tipo: 'macrocategoria', pietanze: []),
      Categoria(id: 'macro2', macrocategoriaId: 'macro2', nome: 'PRIMI PIATTI', ordine: 2, emoji: '🍝', tipo: 'macrocategoria', pietanze: []),
      Categoria(id: 'macro3', macrocategoriaId: 'macro3', nome: 'SECONDI PIATTI', ordine: 3, emoji: '🥩', tipo: 'macrocategoria', pietanze: []),
      Categoria(id: 'macro4', macrocategoriaId: 'macro4', nome: 'PIZZE', ordine: 4, emoji: '🍕', tipo: 'macrocategoria', pietanze: []),
      Categoria(id: 'macro5', macrocategoriaId: 'macro5', nome: 'BEVANDE', ordine: 5, emoji: '🥤', tipo: 'macrocategoria', pietanze: []),
      Categoria(id: 'sotto1', macrocategoriaId: 'macro4', nome: 'PIZZE ROSSE', ordine: 1, emoji: '🍅', tipo: 'sottocategoria', idPadre: 'macro4', pietanze: []),
      Categoria(id: 'sotto2', macrocategoriaId: 'macro4', nome: 'PIZZE BIANCHE', ordine: 2, emoji: '🧀', tipo: 'sottocategoria', idPadre: 'macro4', pietanze: []),
      Categoria(id: 'sotto3', macrocategoriaId: 'macro5', nome: 'BIRRE', ordine: 1, emoji: '🍺', tipo: 'sottocategoria', idPadre: 'macro5', pietanze: []),
      Categoria(id: 'sotto4', macrocategoriaId: 'macro5', nome: 'VINI', ordine: 2, emoji: '🍷', tipo: 'sottocategoria', idPadre: 'macro5', pietanze: []),
    ];
  }
