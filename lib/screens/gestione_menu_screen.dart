      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            if (pietanza.allergeni != null)
              Text('⚠️ ${pietanza.allergeni!}', style: const TextStyle(fontSize: 11, color: Colors.orange)),
          ],
        ),
        trailing: Row(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              nav.pop();
              try {
                await FirebaseFirestore.instance.collection('pietanze').doc(pietanza.id).delete();
