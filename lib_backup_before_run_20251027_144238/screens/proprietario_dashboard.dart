...
class ProprietarioDashboard extends StatelessWidget {
  ...
  final pietanzeInLavorazione = ordini.expand((o) => o.pietanze)
    .where((p) => p.stato == StatoPietanza.inAttesa || p.stato == StatoPietanza.inPreparazione).length;
  final pietanzePronte = ordini.expand((o) => o.pietanze).where((p) => p.stato == StatoPietanza.pronto).length;
