...
class _RegaloPuntiScreenState extends State<RegaloPuntiScreen> {
  ...
  void _cercaCliente() async {
    ...
    final cliente = await FirebaseService.clientAuth.getClienteByTelefono(telefono);
  ...
  // Capture messenger and navigator before awaiting to avoid using
  // BuildContext after an async gap (use_build_context_synchronously).
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    onChanged: (value) {
                      // Cerca automaticamente quando il telefono è completo
                      if (value.length >= 10) {
                        _cercaCliente();
                      }
                    },
            ...
            if (_isSearching)
              ...
              const Card(
                color: Color(0xFFFFEBEE), // Rosso chiaro fisso
                child: Padding(
