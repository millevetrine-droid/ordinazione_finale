...
class MenuTestDataService {
  ...
  List<Pietanza> _creaPietanzeDiTest() {
    return [
      ...
      Pietanza(id: '1', nome: 'Bruschetta al Pomodoro', prezzo: 6.00, categoria: 'ANTIPASTI', categoriaId: 'macro1', macrocategoriaId: 'macro1', descrizione: 'Pane tostato con pomodoro fresco e basilico', immagine: '🍅', ordine: 1),
      Pietanza(id: '2', nome: 'Antipasto della Casa', prezzo: 12.00, categoria: 'ANTIPASTI', categoriaId: 'macro1', macrocategoriaId: 'macro1', descrizione: 'Selezione di salumi e formaggi locali', immagine: '🧀', ordine: 2),
      Pietanza(id: '3', nome: 'Spaghetti Carbonara', prezzo: 12.00, categoria: 'PRIMI PIATTI', categoriaId: 'macro2', macrocategoriaId: 'macro2', descrizione: 'Spaghetti, uova, guanciale, pecorino', immagine: '🍝', ordine: 1),
      Pietanza(id: '4', nome: 'Risotto ai Funghi', prezzo: 14.00, categoria: 'PRIMI PIATTI', categoriaId: 'macro2', macrocategoriaId: 'macro2', descrizione: 'Risotto con funghi porcini freschi', immagine: '🍄', ordine: 2),
      // For subcategories we attach the parent macrocategoriaId (PIZZE -> macro4, BEVANDE -> macro5)
      Pietanza(id: '5', nome: 'Margherita', prezzo: 8.50, categoria: 'PIZZE ROSSE', categoriaId: 'sotto1', macrocategoriaId: 'macro4', descrizione: 'Pomodoro, mozzarella, basilico fresco', immagine: '🍕', ordine: 1),
      Pietanza(id: '6', nome: 'Diavola', prezzo: 10.00, categoria: 'PIZZE ROSSE', categoriaId: 'sotto1', macrocategoriaId: 'macro4', descrizione: 'Pomodoro, mozzarella, salame piccante', immagine: '🌶️', ordine: 2),
      Pietanza(id: '7', nome: 'Quattro Formaggi', prezzo: 11.00, categoria: 'PIZZE BIANCHE', categoriaId: 'sotto2', macrocategoriaId: 'macro4', descrizione: 'Mozzarella, gorgonzola, parmigiano, fontina', immagine: '🧀', ordine: 1),
      Pietanza(id: '8', nome: 'Birra Moretti', prezzo: 4.50, categoria: 'BIRRE', categoriaId: 'sotto3', macrocategoriaId: 'macro5', descrizione: 'Birra bionda 33cl', immagine: '🍺', ordine: 1),
      Pietanza(id: '9', nome: 'Birra Ichnusa', prezzo: 5.00, categoria: 'BIRRE', categoriaId: 'sotto3', macrocategoriaId: 'macro5', descrizione: 'Birra sarda 33cl', immagine: '🍺', ordine: 2),
      Pietanza(id: '10', nome: 'Chianti Classico', prezzo: 18.00, categoria: 'VINI', categoriaId: 'sotto4', macrocategoriaId: 'macro5', descrizione: 'Vino rosso toscano, bicchiere 0.2L', immagine: '🍷', ordine: 1),
    ];
  }
