...
class _ProfiloClienteScreenState extends State<ProfiloClienteScreen> {
  ...
  void _caricaProfiloCliente() async {
    try {
      ...
      // Capture messenger before showing any SnackBar to avoid using BuildContext after async
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildStatistica('Regalati', '0', Icons.card_giftcard),
                      _buildStatistica('Ricevuti', '0', Icons.redeem),
                      _buildStatistica('Ordini', '0', Icons.shopping_bag),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildStatistica(String titolo, String valore, IconData icona) {
    return Column(
      children: [
        Icon(icona, size: 30, color: const Color(0xFF8B4513)),
        const SizedBox(height: 5),
        Text(titolo, style: const TextStyle(fontSize: 12, color: Colors.grey)),
        Text(valore, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
      ],
    );
  }
