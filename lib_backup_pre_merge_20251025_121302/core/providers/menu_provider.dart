...
class MenuProvider with ChangeNotifier {
  ...
  // Backwards-compatible alias used by older tests and code
  ...
  // Backwards-compatible no-op that existed in the older API.
  // The provider already initializes itself in the constructor, so this
  // just returns immediately for compatibility with tests that call it.
