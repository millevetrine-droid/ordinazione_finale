...
class MenuFirestoreService {
  ...
  Future<List<Pietanza>> _caricaPietanze() async {
    ...
    // Ordiniamo lato client per evitare la necessità di indici composti
  ...
  // 🔥 METODO PARSING COLORE
  // Color parsing is delegated to ColorParser in utils/color_utils.dart
  ...
  Future<void> salvaOfferta(Map<String, dynamic> offerta) async {
    ...
    // Serializza il colore in modo robusto: usa una stringa hex (#AARRGGBB) per
    // mantenere compatibilità tra piattaforme e evitare accessi deprecati a .value
  ...
  // Converte un Color in stringa hex con alpha (#AARRGGBB)
  // Color serialization delegated to ColorParser
  ...
  // MIGRAZIONE: converte i colori legacy (int) in stringhe hex '#AARRGGBB'
  // Questo metodo è idempotente: aggiorna solo i documenti che hanno
  // il campo 'colore' come integer. Usa batch commit per efficienza.
  // Restituisce il numero di documenti aggiornati.
